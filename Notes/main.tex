...
\renewcommand*{\subfile}[1]{%
    ...
    \expandafter
    \graphicspath\expandafter{\expandafter{\filename@area}}% Used for graphicx package
    \expandafter
    \lstset\expandafter{inputpath={\expandafter\filename@area}}% Set listings search path
    \org@subfile{#1}
    \lstset{inputpath=\currfiledir}% Reset listings search path using currfile package
}
\makeatother
