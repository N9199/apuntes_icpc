...
\lstinputlisting[firstline=3]{bfs/bfs.cpp}
...
\lstinputlisting[firstline=3]{floydWarshall/floydWarshall.cpp}
...
\lstinputlisting[firstline=3]{treeDiameter/treeDiameter.cpp}
\end{document}